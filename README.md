...
This is a python based automation tool I created that obfuscates a powershell reverse TCP payload generated using Villain framework and prepares it for embedding into a microsoft word VBA macro.
